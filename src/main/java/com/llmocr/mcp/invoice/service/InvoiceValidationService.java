...
public class InvoiceValidationService {
    ...
    public List<String> validateInvoice(Invoice invoice) {
        ...
        if (invoice.getTotalAmount() != null) {
            // Allow zero amounts for invoices with line items to be added later
            // Allow negative amounts for credit memos/refunds
            // Zero is OK if line items will be added
