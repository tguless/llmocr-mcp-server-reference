...
public interface InvoiceRepository extends JpaRepository<Invoice, Long> {
    ...
    // Alternate order for tools that call with id first
    ...
    // Vendor-ID aware queries (NEW - support proper vendor foreign key)
    ...
    // Vendor-ID based duplicate detection (NEW - more accurate)
    @Query("SELECT i FROM Invoice i WHERE i.tenantId = :tenantId " +
